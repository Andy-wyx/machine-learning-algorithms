...
class Actor(object):
    def __init__(self, sess, n_features, action_bound, lr=0.0001):
        ...
        with tf.name_scope('exp_v'):
            ...
            # Add cross entropy cost to encourage exploration  鼓励探索的一种方法，熵越小，确定性越大，越不爱探索
...
plt.plot(np.arange(MAX_EPISODE), reward , color='blue') 
...
plt.savefig(dirname+'/Pendulum_reward.png')
plt.show()  